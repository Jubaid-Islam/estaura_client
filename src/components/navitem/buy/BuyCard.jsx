...
const BuyCard = () => {
  ...
  }, [buyProperties, searchTerm, priceMin, priceMax, bedrooms, bathrooms, propertyType]);
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-center mb-8">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
            Properties for <span className="text-indigo-600">Sale</span>
          </h2>
          <p className="text-gray-500 text-lg">
            Find your dream home from our exclusive listings
          </p>
        </div>
        {/* Mobile filter icon with badge */}
      ...
      <div className="hidden md:block bg-white rounded-2xl shadow-md border border-gray-100 p-5 mb-8 transition-all">
        ...
        {activeFilterCount > 0 && (
          <div className="flex flex-wrap items-center gap-2 mt-4 pt-4 border-t border-gray-100">
            ...
            <button onClick={resetFilters} className="text-xs bg-indigo-50 text-indigo-600 px-3 py-1 rounded-full hover:bg-indigo-100 ml-2">
              Clear all
            </button>
          </div>
        )}
          ...
          <div className="bg-white rounded-2xl w-full max-w-md max-h-[85vh] overflow-y-auto shadow-xl animate-in slide-in-from-bottom duration-300">
            ...
            <div className="p-5 space-y-5">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-xl transition mt-2"
              >
                Reset all filters
              </button>
            </div>
