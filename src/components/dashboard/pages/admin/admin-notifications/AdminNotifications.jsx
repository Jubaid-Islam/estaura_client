...
const typeBadge = (type) => {
  const map = {
    property_submitted: { label: "New Submission", color: "bg-blue-100 text-blue-700" },
          ...
          {visibleNotifications.map((notif) => {
            ...
            return (
              <div
                ...
                className={`flex gap-3 p-4 rounded-2xl border transition cursor-pointer hover:shadow-sm hover:scale-[1.01] ${
                  !notif.isRead
