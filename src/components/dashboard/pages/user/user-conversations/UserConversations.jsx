...
const UserConversations = () => {
  ...
  const { conversations, isLoading } = useConversations(clientId, "user");
            ...
            <div className="flex-1 overflow-y-auto">
              {filtered.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Start by messaging an agent on a property.</p>
                </div>
              ) : (
                filtered.map((conv) => (
                  <button
