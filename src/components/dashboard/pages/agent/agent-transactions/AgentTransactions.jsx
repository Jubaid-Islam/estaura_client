...
import {
  ...
  Calendar, Home, Key, ChevronDown, ChevronUp,
  Dot,
  Tag
} from "lucide-react";
import useUser from "../../../../../hooks/user/useUser";
import useAgentTransactions from "../../../../../hooks/transactions/useAgentTransactions";
...
const AgentTransactions = () => {
  ...
  const { buyTransactions, rentTransactions, transactions, isLoading } = useAgentTransactions(agentId);
      ...
      <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center max-w-[190px] bg-white border border-gray-200 rounded-xl p-1 shadow-sm gap-1 ml-auto sm:ml-0">
            {[
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-lg text-xs font-medium transition ${activeFilter === tab.key
        ...
        {transactions.length === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm text-center py-20">
            ...
            <p className="text-sm text-gray-400 mt-1">Client payments will appear here.</p>
          </div>
        ) : (
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
              ...
              {/* Total Earned — primary highlight */}
              ...
              <div className="flex flex-col md:flex-row md:gap-6 ">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">
                    <span className="font-semibold text-gray-900">${Number(totalBuy).toLocaleString()}</span> from sales
                  </span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">
                    <span className="font-semibold text-gray-900">${Number(totalRent).toLocaleString()}</span> from rent
                  </span>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              {[...displayedBuy, ...displayedRent].length === 0 ? (
                ...
                [...displayedBuy, ...displayedRent]
                  ...
                  .map((t, i, arr) => (
                    <TxRow key={t._id} transaction={t} isLast={i === arr.length - 1} />
                  ))
              )}
            </div>
          </div>
      ...
      <div className="col-span-4 flex items-center gap-3 min-w-0">
        <div className="w-11 h-11 rounded-xl overflow-hidden flex-shrink-0 bg-gray-100">
          {transaction.propertyImage ? (
            <img
              src={cloudinaryUrl(transaction.propertyImage, { width: 90 })}
              alt=""
              loading="lazy"
