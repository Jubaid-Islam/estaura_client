            ...
            <div className="bg-white rounded-2xl overflow-hidden transition-all duration-300">
              <div className="relative h-35 md:h-56 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  ...
                  {
                    property.featured && <span className="px-2 py-0.5 md:px-3 md:py-1 bg-indigo-500 text-white text-[8px] md:text-[10px] font-bold rounded-md uppercase tracking-wider">Featured</span>
                  }
              ...
              <div className="py-4 px-2">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <div className="text-rose-500 font-bold text-[12px]">{property.price}<span className="text-[10px] text-gray-400 font-normal"> /month</span></div>
